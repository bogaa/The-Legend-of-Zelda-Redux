...
bank 1;
org $b5d4			//SRAM Routine $7d5b
	cmp #$32		//Fix wand windup colusion behind link when swinging the wand.
	bne $08
...
org $ED18			//Beeping when low health
	LDA $066F      //Check health          
	AND #$0F                 
	BNE NoBeeping                
	LDA $0604     	//Generate beep ID           
	ORA #$40                 
	STA $0604                
NoBeeping:
