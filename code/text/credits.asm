...
low_bytes:
	...
	db credits_16,credits_17
	db credits_18,credits_19
...
high_bytes:
	...
	db credits_16>>8,credits_17>>8,
	db credits_18>>8,credits_19>>8
...
db $00,$AA,$FF,$FF,$55,$AA,$AA,$FF,$FF,$FF,$55,$00,$00,$00,$00,$00,$00,$00,$50,$00,$00,$00,$AA,$00,$00
...
ExtraCredits:
	STY $050A  	//HijackFix
	tya
	cmp #$08	//Line I like to draw different things
	bne Text2
	ldx #$06	//Leanth of name
LoopText1:	
	lda credits_New1,x
	sta $310,x
	dex
...
//$50A	Does Count a line of NT data
...
BitCheck:	
	...
	CPY #$1b			//Compare if the end of the table is reached? SecondQuest? $17                 
	BCS LineStepper            
	LDX $16                  
	LDA $062D,x            
	BNE TextCheck              
